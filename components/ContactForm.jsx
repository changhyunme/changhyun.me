...
const ContactForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await fetch("/legacy/api/sendEmail", {
                method: "POST",
                headers: {
        ...
        <div>
            <form onSubmit={handleSubmit}>
                ...
                <div className="text-xs mb-5 text-text/50">
                    ...
                    <br />
                    <a href="/legacy/privacy" className="underline hover:text-text transition-colors">
                        {t("privacy.viewPrivacy")} →
                    </a>
                </div>
